...
-- Personas jurídicas (importar desde un archivo plano)
...
--Identificamos que los empleados no tenían asociada la sucursal correspondiente, así que editamos la tabla empleados (ver create_databe)
